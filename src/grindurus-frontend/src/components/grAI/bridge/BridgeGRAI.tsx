...
import arbitrumLogo from '@/assets/tokens/logoArbitrum.png'
import baseLogo from '@/assets/tokens/logoBase.png'
import optimismLogo from '@/assets/tokens/logoOptimism.png'
import polygonLogo from '@/assets/tokens/logoPolygon.png'
import solanaLogo from '@/assets/tokens/logoSolana.png'
