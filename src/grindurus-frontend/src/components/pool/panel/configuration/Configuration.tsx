    ...
    <div className={`${styles['configuration']} form`}>
      ...
      <div className={styles['content']}>
        <div className={styles['row']}>
          <FormGroup
            label={`Long Number Max (Current value: ${longNumberMax.toString()})`}
          ...
          <FormGroup
            label={`Hedge Number Max (Current value: ${hedgeNumberMax.toString()})`}
            className={styles['form-group']}
          >
            <div className="form-input">
              <input
        ...
        <div className={styles['row']}>
          <FormGroup
            label={`Extra Coefficient (Current value: ${extraCoef.toString()})`}
            className={styles['form-group']}
          >
            <div className="form-input">
              <input
              ...
              />
              <button className={`${styles['button']} button`} onClick={() => handleSetExtraCoef()}>
                Set
              </button>
            </div>
          </FormGroup>
          <FormGroup
            label={`Price Volatility Percent (Current value: ${priceVolatilityPercent.toString()})`}
            className={styles['form-group']}
          >
            <div className="form-input">
              <input
        ...
        <div className={styles['row']}>
          <FormGroup
            label={`Operation & Return Percent (Current value: ${
              selectedOpReturnPercent === 1
                ? longSellReturnPercent
                : selectedOpReturnPercent === 2
                ? hedgeSellReturnPercent
                : selectedOpReturnPercent === 3
          ...
          >
            <div className={styles['operation-row']}>
              <Select
                onChange={value => setSelectedOpReturnPercent(value as number)}
          ...
          <FormGroup
            label={`Operation & Fee Coef (Current value: x${
              selectedOpFeeCoef === 1
                ? longSellFeeCoef
                : selectedOpFeeCoef === 2
                ? hedgeSellFeeCoef
          ...
          >
            <div className={styles['operation-row']}>
              <Select
                onChange={value => setSelectedOpFeeCoef(value as number)}
                className={styles['select']}
              >
                <Option value={1}>Long sell</Option>
                <Option value={2}>Hedge sell</Option>
              ...
              <div className={`${styles['form-input']} form-input`}>
                ...
                />
                <button className={`${styles['button']} button`} onClick={() => handleSetFeeCoef()}>
                  Set
                </button>
              </div>
            </div>
